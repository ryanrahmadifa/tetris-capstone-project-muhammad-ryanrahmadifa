...
if page == 'Project':
    ...
    with bot2:
        ...
        data_m = px.bar(df_marketing,
                    ...
                    x='media',
                    color = 'media',
                    color_discrete_map={'Instagram': '#AB63FA','TikTok': '#19D3F3','YouTube':'#D62728','Facebook':'#636EFA'},
                    height= 300,
                    range_y=[0,100],
                    orientation='v')
    ...
    with act1:
        ...
        fig_sum = px.scatter(summary, x="market", y="users",color='media',color_discrete_map={'Instagram': '#AB63FA','TikTok': '#19D3F3','YouTube':'#D62728','Facebook':'#636EFA'},size = 'age', trendline='ols',trendline_scope = 'overall',trendline_color_override = 'blue')
