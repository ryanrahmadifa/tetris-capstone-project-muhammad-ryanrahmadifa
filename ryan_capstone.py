...
if page == 'Project':
    ...
    with bot2:
        ...
        data_m = px.bar(df_marketing,
                    ...
                    x='media',
                    color = 'media',
                    color_discrete_map={'Instagram': '#AB63FA','TikTok': '#19D3F3','Youtube':'#DC3912','Facebook':'#636EFA','Pinterest':'#FFA15A','Twitter':'#FF6692','Snapchat':'#B6E880','Blogs':'#FF97FF','Twitch':'#FECB52'},
                    height= 300,
                    range_y=[0,100],
                    orientation='v')
    ...
    with act1:
        ...
        fig_sum = px.scatter(summary, x="market", y="users",color='media',color_discrete_map={'Instagram': '#AB63FA','TikTok': '#19D3F3','Youtube':'#DC3912','Facebook':'#636EFA','Pinterest':'#FFA15A','Twitter':'#FF6692','Snapchat':'#B6E880'},size = 'age', trendline='ols',trendline_scope = 'overall',trendline_color_override = 'blue')
